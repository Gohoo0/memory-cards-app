...
questions_list = []  
questions_list.append(Question('4 Мутанта живущие в канализации?','чебурашки-ниньзя', 'черепашки-ниньзя', 'кто это?','крыса'))
questions_list.append(Question('Каккой по счету день недели воскресенье?','не знаю','седьмой','вторник','в ананас',))
questions_list.append(Question('Как Кроули называл Дина и Сема','бельчонок и лосяра','корова и бык','бивеньи камень ','Кастиэль')) 
